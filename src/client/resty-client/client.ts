/*
 * @Author: kasuie
 * @Date: 2024-08-29 10:16:53
 * @LastEditors: kasuie
 * @LastEditTime: 2024-08-29 10:22:50
 * @Description:
 */
import {
  ApisConfig,
...
export class Client {
  ...
  static useReq(
    onFulfilled?: ResolvedMiddleWare<RequestOptions>,
  ...
  static useRes(
    onFulfilled?: ResolvedMiddleWare<AxiosResponse>,
    onRejected?: RejectedMiddleWare
  ) {
  ...
  public get<T extends Record<string, any> = any>(
    url: string,
  ...
  public delete<T extends Record<string, any> = any>(
    url: string,
    request: RequestOptions
  ): Promise<RestyResponse<T>> {
  ...
  public post<T extends Record<string, any> = any>(
    url: string,
    request: RequestOptions
  ): Promise<RestyResponse<T>> {
  ...
  public put<T extends Record<string, any> = any>(
    url: string,
    request: RequestOptions
  ): Promise<RestyResponse<T>> {
  ...
  public patch<T extends Record<string, any> = any>(
    url: string,
    request: RequestOptions
  ): Promise<RestyResponse<T>> {
  ...
  public request<T extends Record<string, any> = any>(
    url: string,
    request: RequestOptions
  ): Promise<RestyResponse<T>> {
