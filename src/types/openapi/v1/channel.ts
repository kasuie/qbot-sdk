...
export interface ChannelAPI {
  ...
  postChannel: (
    guildID: string,
    channel: PostChannelObj
  ) => Promise<RestyResponse<IChannel>>;
  patchChannel: (
    channelID: string,
    channel: PatchChannelObj
  ) => Promise<RestyResponse<IChannel>>;
...
export type PatchChannelObj = Partial<
  Omit<PostChannelObj, "sub_type" | "private_user_ids">
>;
