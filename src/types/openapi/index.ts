 ...
 * @LastEditors: kasuie
 * @LastEditTime: 2024-08-29 20:18:22
 * @Description:
 */
import { RequestOptions, RestyResponse } from "@src/client/resty-client";
...
import { GroupAPI } from "./v2/group";
import { C2CAPI } from "./v2/c2c";

export type OpenAPIRequest = <T extends Record<any, any> = any>(
