...
export enum AvailableIntentsEventsEnum {
  ...
  /** 单聊消息 */
  C2C_MESSAGES = "C2C_MESSAGES",

  /** 单聊操作 */
  C2C_ACTION = "C2C_ACTION",
}
...
export const WsEventType: { [key: string]: AvailableIntentsEventsEnum } = {
  ...
  //  ======= GUILD_MESSAGES ======
  MESSAGE_CREATE: AvailableIntentsEventsEnum.GUILD_MESSAGES, // 文字子频道内发送聊天消息时触发（全量,私域）
  ...
  //  ======= PUBLIC_GUILD_MESSAGES ======
  AT_MESSAGE_CREATE: AvailableIntentsEventsEnum.PUBLIC_GUILD_MESSAGES, // 频道@机器人或回复机器人消息时触发
  PUBLIC_MESSAGE_DELETE: AvailableIntentsEventsEnum.PUBLIC_GUILD_MESSAGES, // 当频道的消息被删除时

  /** v2 */
  // GROUP_ACTION
  GROUP_AT_MESSAGE_CREATE: AvailableIntentsEventsEnum.GROUP_MESSAGES, // 机器人在群里被@
  GROUP_ADD_ROBOT: AvailableIntentsEventsEnum.GROUP_ACTION, // 机器人加入群聊
  GROUP_DEL_ROBOT: AvailableIntentsEventsEnum.GROUP_ACTION, // 机器人退出群聊
  GROUP_MSG_REJECT: AvailableIntentsEventsEnum.GROUP_MESSAGES, // 群聊拒绝机器人主动消息
  GROUP_MSG_RECEIVE: AvailableIntentsEventsEnum.GROUP_MESSAGES, // 群聊接受机器人主动消息

  // USER_ACTION
  C2C_MESSAGE_CREATE: AvailableIntentsEventsEnum.C2C_MESSAGES, // 当收到用户在消息列表发给机器人的消息时
  FRIEND_ADD: AvailableIntentsEventsEnum.C2C_ACTION, // 用户添加机器人到消息列表
  FRIEND_DEL: AvailableIntentsEventsEnum.C2C_ACTION, // 用户删除机器人
  C2C_MSG_REJECT: AvailableIntentsEventsEnum.C2C_MESSAGES, // 用户拒绝机器人主动消息
  C2C_MSG_RECEIVE: AvailableIntentsEventsEnum.C2C_MESSAGES, // 用户允许机器人主动消息
};
...
export interface WsRespData {
  eventType: AvailableIntentsEventsEnum;
  eventId: string;
  msg: any;
}
