...
export default class Announce implements AnnounceAPI {
  ...
  // 创建guild公告
  public postGuildAnnounce(
    guildID: string,
    channelID: string,
    messageID: string
  ): Promise<RestyResponse<IAnnounce>> {
    const options = {
